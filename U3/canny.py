#VISTO ASI NOMAS ! mucho texto
#Basicamente implementa una funcion propia de canny
#En el archivo canny_example.py puede verse que logro 
#un metodo similar al implementado por cv2
