...
#A cada pixel de label de la imagen lo coloreo con el color correspodiente
# en la paleta segun su label. Referencias:
# center : Matriz con los colores de los centroides (K colores)
# label : Vector con los label de cada dato (K labels distintos y Z.shape[0] datos)
...
plt.show(block=False)
# Porque no se ven casi puntos para cada color?? Analizar... La mascara se hizo con img en vez de imgQ
