...
for ii in range(N_colours):
    ...
    mask = maskR & maskG & maskB #Matriz binaria del tamaño de la imagen, True en cada pixel del color seleccionado (col_sel)
    img_idx[mask] = ii
    print("p")
    # --- Version compacta -------------------------------------------------------------------
...
#Dicho por el profe en clase:
    #En la imagen peppers no comprimo nada porque son muchos colores diferentes
    #En la imagen home si comprimo un 7/8%